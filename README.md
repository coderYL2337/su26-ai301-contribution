...
There's a clear pattern to follow. Looking at how other buttons like Button are implemented in the codebase (with a #if SKIP block containing a @Composable Render function), I would do the same thing here. The repo README even walks through the exact implementation phases.
